...
- A Rust `ferrite-protocol-wasm` crate and `@ferrite/protocol-wasm` TypeScript package that expose Rust server-payload validation to browser-capable WASM consumers.
