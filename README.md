...
- A native Node package, `@ferrite/node`, that exposes Rust SSR to JavaScript consumers through a Node-API addon and can resolve local source builds or optional platform prebuild packages.
