...
ferrite serve --project examples/basic --host 127.0.0.1 --port 3000 --render-timeout-ms 30000 --request-read-timeout-ms 5000 --max-request-bytes 16384 --max-in-flight-requests 64 --server-action-csrf-token-env FERRITE_ACTION_CSRF --access-log json
