...
- [ ] Add full server-action CSRF/session/replay hardening: token rotation, session binding, cookie guidance, forwarded client-IP trust policy, replay considerations, and clearer auth integration guidance.
